                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> ขีดจำกัดการเซ็ตบ้าน</h1>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> ขีดจำกัดวางโพรเทค</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> ดึงผู้เล่นมาหาเรา</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> ขีดจำกัดการวางขาย</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> ย้อนกลับจุดที่มาล่าสุด</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> เปลี่ยนชื่อเล่น</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> ตัดต้นไม้ล้มทั้งต้น</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
                    ...
                    <div className="grid grid-cols-5 w-full">
                        <div className="bg-[#87b925] w-full p-6">
                            <div className="h-16 flex flex-col justify-center items-center">
                                ...
                                <h1 className="text-xl text-white"><span className="text-red-700">อธิบาย:</span> เทเลพอร์ตไปหาผู้เล่น</h1>
                            </div>
                        </div>
                        <div className="bg-white w-full p-6 border-l">
                            <div className="h-16 flex justify-center items-center">
